...
namespace AdministracionCampeonatosQuimera.Controllers1
{
    public class EquipoesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CelularCapitan,Nombre,NombreCapitan,UrlFoto")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
