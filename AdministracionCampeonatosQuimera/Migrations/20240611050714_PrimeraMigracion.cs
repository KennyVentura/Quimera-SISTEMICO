        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CantEquipos = table.Column<int>(type: "INTEGER", nullable: false),
                    CostoInscripcion = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CelularCapitan = table.Column<int>(type: "INTEGER", nullable: false),
                    Nombre = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificados_Campeonatos_CampeonatoId",
                        column: x => x.CampeonatoId,
                        principalTable: "Campeonatos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Certificados_Equipos_EquipoId",
                        column: x => x.EquipoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certificados_CampeonatoId",
                table: "Certificados",
                column: "CampeonatoId");

            migrationBuilder.CreateIndex(
                name: "IX_Certificados_EquipoId",
                table: "Certificados",
                column: "EquipoId");
